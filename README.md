...
| 산출물 | 링크 |
| ----------------------------------- | -------------------- |
| 요구사항 정의서 | [복약메이트_요구사항정의서.xlsx](./Deliverables/복약메이트_요구사항정의서.xlsx) |
| 화면 설계서 | [화면설계서.md](./Deliverables/화면설계서.md) |
| 시스템 구성도 |  (상단 아키텍처 참고) |
| 기능 명세서 | [기능명세서.md](./Deliverables/기능명세서.md) |
| 테스트 계획서 및 테스트 결과 보고서 | [4_테스트 계획서 및 결과 보고서.xlsx](./Deliverables/4_테스트%20계획서%20및%20결과%20보고서.xlsx) |
